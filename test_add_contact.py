...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_new_contact(wd, first_name="Adam", middle_name="Jan", last_name="Kowalski", nickname="dsksljd",
    ...
    def test_add_empty_contact(self):
        ...
        self.open_main_page(wd)
        self.login(wd, username="admin", password="secret")
        self.create_new_contact(wd, first_name="", middle_name="", last_name="", nickname="",
    ...
    def create_new_contact(self, wd, first_name, middle_name, last_name, nickname, company_title, company_name,
                           company_address, home_phone, mobile_phone, work_phone, fax, email, email_2, email_3,
                           homepage, birth_day, birth_month, birth_year, ann_day, ann_month, ann_year, address_2,
                           phone_2, notes):
        ...
        if not wd.find_element_by_xpath(birth_day).is_selected():
            wd.find_element_by_xpath(birth_day).click()
        ...
        if not wd.find_element_by_xpath(ann_day).is_selected():
            wd.find_element_by_xpath(ann_day).click()
        if not wd.find_element_by_xpath(ann_month).is_selected():
            wd.find_element_by_xpath(ann_month).click()
